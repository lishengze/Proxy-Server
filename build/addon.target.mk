...
OBJS := \
	...
	$(obj).target/$(TARGET)/ftdcsysuserapi-wrapper.o \
	$(obj).target/$(TARGET)/sysuserspi.o \
	$(obj).target/$(TARGET)/v8-transform-data.o \
	$(obj).target/$(TARGET)/v8-transform-func.o \
	$(obj).target/$(TARGET)/id-func.o \
	$(obj).target/$(TARGET)/tool-function.o \
	$(obj).target/$(TARGET)/charset-convert-linux.o \
	$(obj).target/$(TARGET)/CDes.o
